...
\newcommand{\xboxf}[2]{\vspace{1em}\fcolorbox{grey}{white}{\parbox{#1}{\textcolor{grey}{#2}}}}
...
\paragraph{Winsch}
Seilwinde im Cockpit zum dichtholen der von Tampen. Die Tampen werden mindestens drei Mal um den Winschkörper geschlungen um die Last aufzunehmen und danach in die Führung gelegt.
...
\end{minipage}
\hfill
\makebox[0.45\textwidth]{\xboxf{0.45\textwidth}{Eine Winsch kann sehr große Kräfte aufnehmen. Deswegen: erst schauen wo es klemmt bevor man mit Gewalt kurbelt.}}
\end{minipage}
